...
+function (jQuery) { "use strict";
  ...
  Carousel.prototype.slide = function (type, next) {
    ...
    var e = jQuery.Event('slide.bs.carousel', { relatedTarget: $next[0], direction: direction })
...
+function (jQuery) { "use strict";
  ...
  Collapse.prototype.hide = function () {
    ...
    this.$element
      [dimension](0)
      .one($.support.transition.end, jQuery.proxy(complete, this))
      .emulateTransitionEnd(350)
  }
...
+function (jQuery) { "use strict";
  ...
  var Dropdown = function (element) {
    var $el = jQuery(element).on('click.bs.dropdown', this.toggle)
  }
  ...
  Dropdown.prototype.toggle = function (e) {
    ...
    if (!isActive) {
      ...
      $parent.trigger(e = jQuery.Event('show.bs.dropdown'))
  ...
  Dropdown.prototype.keydown = function (e) {
    ...
    var $items = jQuery('[role=menu] li:not(.divider):visible a', $parent)
  ...
  function clearMenus() {
    ...
    jQuery(toggle).each(function (e) {
      ...
      $parent.trigger(e = jQuery.Event('hide.bs.dropdown'))
      if (e.isDefaultPrevented()) return
...
+function (jQuery) { "use strict";
  ...
  function ScrollSpy(element, options) {
    ...
    this.$element       = jQuery(element).is('body') ? jQuery(window) : jQuery(element)
  ...
  ScrollSpy.prototype.refresh = function () {
    ...
    var $targets = this.$body
      ...
      .map(function () {
        ...
        return ($href
          && $href.length
          && [[ $href[offsetMethod]().top + (!jQuery.isWindow(self.$scrollElement.get(0)) && self.$scrollElement.scrollTop()), href ]]) || null
      })
